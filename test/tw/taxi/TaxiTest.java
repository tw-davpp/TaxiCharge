...
public class TaxiTest {
    ...
    @Test
    public void test_sixty_mile_per_hour_cost_zero_waiting_price() {
    ...
    @Test
    public void test_two_hundred_forty_mile_per_hour_cost_one_waiting_price() {
        taxi.update(new Time("10:10"), new Time("10:11"), 2);
    ...
    @Test
    public void test_at_twenty_two_drive_ten_mile_cost_ten_evening_price() {
        taxi.update(new Time("21:59"), new Time("22:00"), 2);
        taxi.update(new Time("22:00"), new Time("22:01"), 10);
